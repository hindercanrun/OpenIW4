...
{
	return memory::call<dvar_t*(char*, float, float, float, int, char*)>(0x4051D0)
...
{
	return memory::call<dvar_t*(const char*, bool, unsigned int, const char*)>(0x429390)
...
{
    return memory::call<dvar_t*(const char*, std::int32_t, std::int32_t, std::int32_t, std::int32_t, const char*)>(0x4E9490)(dvarName, a2, a3, a4, a5, description);
}
